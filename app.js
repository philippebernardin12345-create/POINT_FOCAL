...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // LECTEUR INTÉGRÉ — CHRONO DE TEST À 3s (PASSE À 180 POUR LA VERSION FINALE)
    btnRegarder.addEventListener("click", () => {
        ...
        messageDynamique.textContent = "« Interagissez avec la vidéo intégrée (Like, Commentaire) pendant l'analyse... »";
        ...
        const intervalleVisionnage = setInterval(() => {
            ...
            if (tempsVisionnage <= 0) {
                ...
                messageDynamique.textContent = "« Visionnage validé avec succès ! Cliquez sur le bouton ci-dessous. »";
